...
namespace AuviaGS.Models.Static
{
    public class EmailBuilder
    {
        ...
        public string GetTitle()
        {
            return NotificationType switch
            {
                ...
                ActionInvocationTypeEnum.EmailConfirmationMobile => $"Email Confirmation!",
                _ => ""
            };
        }
        ...
        public string GetHeading()
        {
            return NotificationType switch
            {
                ...
                ActionInvocationTypeEnum.EmailConfirmationMobile => $"</br>You has been registered successfully just one more step to finish. </br>",
                _ => ""
            };
        }
        ...
        public string GetBody(string code)
        {
            return NotificationType switch
            {
                ...
                ActionInvocationTypeEnum.ResetPassword => GetResetPasswordEmailBody(code),
                ActionInvocationTypeEnum.EmailConfirmationMobile => GetEmailConfirmationMobileEmailBody(code),
                _ => ""
            };
        }
        ...
        private string GetEmailConfirmationEmailBody()
        {
            ...
            var emailBody = "<div width = \"100% !important\" style=\"background:#fff; width:100%!important; margin:0; padding:0; font-family:'Roboto',Helvetica,sans-serif; color:rgb(70,72,74,.9); font-size:15px; line-height:1.5em\">" +
                      ...
                      "<img data-imagetype=\"External\" src=\"https://auiva.gs/images/AUVIA%20LOGO.png\" width=\"200\" style=\"width:200px\">" +
                      ...
                      $"<br>" +
                      $"<br>" +
                      $"Please follow the link to verify you email <a data-click-track-id=\"381\" href=\"{url}\">Press here</a>. <br><br>Thanks,<br> The Auiva Team<br></td></tr></tbody></table>" +
                      ...
                      "<tbody>" +
                      "<tr width=\"100%\"><td width=\"100%\" style=\"border - collapse:collapse\"><img data-imagetype=\"External\" src=\"https://auiva.gs/images/AUVIA%20LOGO.png\" alt=\"A\" width=\"25\" style=\"width:25px; opacity:.5\">" +
                      "<br aria-hidden=\"true\"><span style=\"color:#fff; color:rgba(255,255,255,.5)\"></span> | <a href=\"\" target=\"_blank\" rel=\"noopener noreferrer\" data-auth=\"NotApplicable\" style=\"text-decoration:none; color:#fff; color:rgba(255,255,255,.5)\" data-linkindex=\"1\">UnSubscribe</a> </td></tr></tbody>";
            return emailBody;
        }


        private string GetResetPasswordEmailBody(string code)
        {
            ...
            var emailBody = "<div width = \"100% !important\" style=\"background:#fff; width:100%!important; margin:0; padding:0; font-family:'Roboto',Helvetica,sans-serif; color:rgb(70,72,74,.9); font-size:15px; line-height:1.5em\">" +
                        ...
                        $"<br>" +
                        $"<br>" +
                        $"Please follow the link to reset your account password <a data-click-track-id=\"381\" href=\"{url}\">Press here</a>. <br><br>Thanks,<br> The Auiva Team<br></td></tr></tbody></table>" +
                        "<table align=\"center\" bgcolor=\"#3599e8\" border=\"0\" cellpadding=\"35\" cellspacing=\"0\" width=\"90%\" style=\"margin:0px auto; text-align:center; max-width:800px; color:rgba(255,255,255,.5); font-size:11px; display:table\">" +
                        "<tbody>" +
                        "<tr width=\"100%\"><td width=\"100%\" style=\"border - collapse:collapse\"><img data-imagetype=\"External\" src=\"https://auiva.gs/images/AUVIA%20LOGO.png\" alt=\"Auiva\" width=\"25\" style=\"width:25px; opacity:.5\">" +
            ...
            var x = "<!DOCTYPE html>\r\n<html>\r\n<head>\r\n  <style>\r\n    /* Add your CSS styles here */\r\n    body {\r\n      font-family: sans-serif;\r\n      color: #333;\r\n    }\r\n    .confirmation-message {\r\n      background-color: #eee;\r\n      padding: 20px;\r\n      border: 1px solid #ccc;\r\n      border-radius: 5px;\r\n    }\r\n    .confirmation-message h1 {\r\n      font-size: 24px;\r\n      margin: 0 0 10px 0;\r\n    }\r\n    .confirmation-message p {\r\n      margin: 0;\r\n      padding: 0;\r\n    }\r\n  </style>\r\n</head>\r\n<body>\r\n  <div class=\"confirmation-message\">\r\n    <h1>Confirmation Email</h1>\r\n    <p>Dear User,</p>\r\n    <p>Thank you for signing up for our service. Please click the following link to confirm your email address:</p>" +
                $"\r\n    <p>your Confirme Code:{code}</p>\r\n    <p>Best regards,</p>\r\n    <p>The Your-Site Team</p>\r\n  </div>\r\n</body>\r\n</html>";

            return x;
        }

        private string GetEmailConfirmationMobileEmailBody(string code)
        {
            var url = URL + $"?confirmation={(Values.ContainsKey("Link") ? Values["Link"] : "")}";
