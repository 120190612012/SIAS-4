...
namespace AuivaGS.DbModel.MangerSP
{
    ...
    {
        Task<List<CreateMassegeResult>> CreateMassegeAsync(int? Sender_ID, int? Receiver_ID, string Massage, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        Task<List<GetChatForChatIDResult>> GetChatForChatIDAsync(int? Chat_ID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        Task<List<GetChatForUserIDResult>> GetChatForUserIDAsync(int? UserID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        Task<List<AddCommitProjectResult>> AddCommitProjectAsync(int? UserID, int? ProjectID, string CommentProject, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        Task<List<GetCommenttoProjectResult>> GetCommenttoProjectAsync(int? UserID, int? ProjectID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
